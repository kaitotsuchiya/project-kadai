...
Original file is located at
    https://colab.research.google.com/drive/1ibNooc2Wuyw_MN7YSQ7VBXkQu0hkE3Mf
"""

#pip install pyworld

import sys
sys.path.append('/content/drive/MyDrive/Colab Notebooks/my_module')
import f0
import librosa
import numpy as np
import shutil
...
path='/content/drive/MyDrive/wavファイル/さくら.wav'
print(path[:-4]+'_mono.wav')